...
hirayoonn = [
    {'moji': 'きゃ', 'spell': ['kya']},
    {'moji': 'ぎゃ', 'spell': ['gya']},
    {'moji': 'しゃ', 'spell': ['sha', 'sya']},
    {'moji': 'じゃ', 'spell': ['ja', 'jya']},
    {'moji': 'ちゃ', 'spell': ['cha', 'cya']},
    {'moji': 'にゃ', 'spell': ['nya']},
    {'moji': 'ひゃ', 'spell': ['hya']},
    {'moji': 'びゃ', 'spell': ['bya']},
    {'moji': 'ぴゃ', 'spell': ['pya']},
    ...
    {'moji': 'きゅ', 'spell': ['kyu']},
    {'moji': 'ぎゅ', 'spell': ['gyu']},
    {'moji': 'しゅ', 'spell': ['shu', 'syu']},
    {'moji': 'じゅ', 'spell': ['ju', 'jyu']},
    {'moji': 'ちゅ', 'spell': ['chu', 'cyu']},
    {'moji': 'にゅ', 'spell': ['nyu']},
    {'moji': 'ひゅ', 'spell': ['hyu']},
    {'moji': 'びゅ', 'spell': ['byu']},
    {'moji': 'ぴゅ', 'spell': ['pyu']},
    ...
    {'moji': 'きょ', 'spell': ['kyo']},
    {'moji': 'ぎょ', 'spell': ['gyo']},
    {'moji': 'しょ', 'spell': ['sho', 'syo']},
    {'moji': 'じょ', 'spell': ['jo', 'jyo']},
    {'moji': 'ちょ', 'spell': ['cho', 'cyo']},
    {'moji': 'にょ', 'spell': ['nyo']},
    {'moji': 'ひょ', 'spell': ['hyo']},
    {'moji': 'びょ', 'spell': ['byo']},
    {'moji': 'ぴょ', 'spell': ['pyo']},
...
katayoonn = [
    {'moji': 'キャ', 'spell': ['kya']},
    {'moji': 'ギャ', 'spell': ['gya']},
    {'moji': 'シャ', 'spell': ['sha', 'sya']},
    {'moji': 'ジャ', 'spell': ['ja', 'jya']},
    {'moji': 'チャ', 'spell': ['cha', 'cya']},
    {'moji': 'ニャ', 'spell': ['nya']},
    {'moji': 'ヒャ', 'spell': ['hya']},
    {'moji': 'ビャ', 'spell': ['bya']},
    {'moji': 'ピャ', 'spell': ['pya']},
    ...
    {'moji': 'キュ', 'spell': ['kyu']},
    {'moji': 'ギュ', 'spell': ['gyu']},
    {'moji': 'シュ', 'spell': ['shu', 'syu']},
    {'moji': 'ジュ', 'spell': ['ju', 'jyu']},
    {'moji': 'チュ', 'spell': ['chu', 'cyu']},
    {'moji': 'ニュ', 'spell': ['nyu']},
    {'moji': 'ヒュ', 'spell': ['hyu']},
    {'moji': 'ビュ', 'spell': ['byu']},
    {'moji': 'ピュ', 'spell': ['pyu']},
    ...
    {'moji': 'キョ', 'spell': ['kyo']},
    {'moji': 'ギョ', 'spell': ['gyo']},
    {'moji': 'ショ', 'spell': ['sho', 'syo']},
    {'moji': 'ジョ', 'spell': ['jo', 'jyo']},
    {'moji': 'チョ', 'spell': ['cho', 'cyo']},
    {'moji': 'ニョ', 'spell': ['nyo']},
    {'moji': 'ヒョ', 'spell': ['hyo']},
    {'moji': 'ビョ', 'spell': ['byo']},
    {'moji': 'ピョ', 'spell': ['pyo']},
